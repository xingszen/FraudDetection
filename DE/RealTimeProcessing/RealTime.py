...
class RealTimeFraudDetection:
   ...
   def _define_schema(self):
       # Define the schema of attributes that needed for fraud detection
       return StructType([
   ...
   def read_from_kafka(self, brokers, topic):
       ...
       # Parse the JSON value sent over Kafka followed a defined schema
   ...
   def analyse_potential_offenders(self, df):
       ...
       # Check for transactions with high velocity scores or geo anomaly scores
...
if __name__ == "__main__":
    ...
    susp_receivers_hdfs_path = "hdfs://localhost:9000/user/student/assignment/realtime/data/suspicious_receivers"
    susp_receivers_checkpoint = "hdfs://localhost:9000/user/student/assignment/realtime/checkpoint_dir/kafka/suspicious_receivers"
    susp_receivers_hdfs_checkpoint = "hdfs://localhost:9000/user/student/assignment/realtime/checkpoint_dir/hdfs/suspicious_receivers"
    
    acc_takeover_topic = "ip-takeover"
    acc_takeover_hdfs_path = "hdfs://localhost:9000/user/student/assignment/realtime/data/ip_takeover"
    acc_takeover_checkpoint = "hdfs://localhost:9000/user/student/assignment/realtime/checkpoint_dir/kafka/ip_takeover"
    acc_takeover_hdfs_checkpoint = "hdfs://localhost:9000/user/student/assignment/realtime/checkpoint_dir/hdfs/ip_takeover"

    potential_offenders_topic = "potential-offenders"
    potential_offenders_hdfs_path = "hdfs://localhost:9000/user/student/assignment/realtime/data/potential_offenders"
    potential_offenders_checkpoint = "hdfs://localhost:9000/user/student/assignment/realtime/checkpoint_dir/kafka/potential_offenders"
    potential_offenders_hdfs_checkpoint = "hdfs://localhost:9000/user/student/assignment/realtime/checkpoint_dir/hdfs/potential_offenders"
    ...
    # susp_receivers_query = pipeline.write_to_kafka(susp_receivers_df, brokers, susp_receivers_topic, susp_receivers_checkpoint)
    # susp_receivers_hdfs_query = pipeline.write_to_hdfs(susp_receivers_df, susp_receivers_hdfs_path, susp_receivers_hdfs_checkpoint)
    ...
    # acc_takeover_query = pipeline.write_to_kafka(acc_takeover_df, brokers, acc_takeover_topic, acc_takeover_checkpoint)
    # acc_takeover_hdfs_query = pipeline.write_to_hdfs(acc_takeover_df, acc_takeover_hdfs_path, acc_takeover_hdfs_checkpoint)
    ...
    # potential_offenders_query = pipeline.write_to_kafka(potential_offenders_df, brokers, potential_offenders_topic, potential_offenders_checkpoint)
    # potential_offenders_hdfs_query = pipeline.write_to_hdfs(potential_offenders_df, potential_offenders_hdfs_path, potential_offenders_hdfs_checkpoint)
