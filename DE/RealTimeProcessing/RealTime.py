...
if __name__ == "__main__":
    ...
    susp_receivers_hdfs_path = "hdfs://localhost:9000/user/student/assignment/realtime_v8/data/suspicious_receivers"
    susp_receivers_checkpoint = "hdfs://localhost:9000/user/student/assignment/realtime_v8/checkpoint_dir/kafka/suspicious_receivers"
    
    acc_takeover_topic = "ip-takeover"
    acc_takeover_hdfs_path = "hdfs://localhost:9000/user/student/assignment/realtime_v8/data/ip_takeover"
    acc_takeover_checkpoint = "hdfs://localhost:9000/user/student/assignment/realtime_v8/checkpoint_dir/kafka/ip_takeover"

    potential_offenders_topic = "potential-offenders"
    potential_offenders_hdfs_path = "hdfs://localhost:9000/user/student/assignment/realtime_v8/data/potential_offenders"
    potential_offenders_checkpoint = "hdfs://localhost:9000/user/student/assignment/realtime_v8/checkpoint_dir/kafka/potential_offenders"
