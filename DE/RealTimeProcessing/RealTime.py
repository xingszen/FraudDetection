...
if __name__ == "__main__":
    ...
    general_topic = "financial-transactions-v22"
    input_topic = "ip-account-detection-v22"
    
    susp_receivers_topic = "suspicious-receivers"
    susp_receivers_hdfs_path = "hdfs://localhost:9000/user/student/assignment/realtime_v22/data/suspicious_receivers"
    susp_receivers_checkpoint = "hdfs://localhost:9000/user/student/assignment/realtime_v22/checkpoint_dir/kafka/suspicious_receivers"
    
    acc_takeover_topic = "ip-takeover"
    acc_takeover_hdfs_path = "hdfs://localhost:9000/user/student/assignment/realtime_v22/data/ip_takeover"
    acc_takeover_checkpoint = "hdfs://localhost:9000/user/student/assignment/realtime_v22/checkpoint_dir/kafka/ip_takeover"
